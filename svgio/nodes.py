...
class Element(Node):
    ...
    if args[0] is a dict or Element class the value is used to seed the values.
...
class SVG(ContainerElement, StructuralElement):
    """
